      ...
      return {
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
          ...
          scope.onDateInputTab = function() {
            if (scope.disableTimepicker) {
              scope.selectDateFromInput(true);
            }
            return true;
          };
